...
public class dPageInfo {
	...
	public void setListCount(int listCount) {
		this.listCount = listCount;
		makePageInfo(); // 해당 값이 변할 때마다 계산식이 다시 이뤄져야함
	}
	...
	public String toString() {
		return "PageInfo [currentPage=" + currentPage + ", listCount=" + listCount + ", limit=" + limit
				...
				+ ", endPage=" + endPage + ", donationType=" + donationType + "]";
	}
	...
	public void setPageInfo(int currentPage, int listCount, int donationType) {
		this.currentPage = currentPage;
		this.listCount = listCount;
		this.donationType = donationType;
