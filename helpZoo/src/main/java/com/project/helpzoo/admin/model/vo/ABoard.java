...
public class ABoard {
	...
	public ABoard(int boardNo, String boardTitle, String boardContent, int readCount, Timestamp boardCreateDate,
			Timestamp boardModifyDate, String boardWriter, int boardType, String boardName, String boardStatus) {
		super();
	...
	public String toString() {
		return "ABoard [boardNo=" + boardNo + ", boardTitle=" + boardTitle + ", boardContent=" + boardContent
				...
				+ boardName + ", boardStatus=" + boardStatus + "]";
	}
