...
<body>
	<div class="preloader">
		...
		<!-- Portfolio Section -->
		<form id="donationMontly" name="donationMontly">
		     <section id="portfolio" style="margin-top: -5%;">
		<div class="container" style="border: 1px solid; height: 950px;">
		<div class="row" style="margin-top: 10px;">
		
		<div class="col-md-6" style="text-align: center;">
		<div class="aaa" style= "padding: 80px;  height: 200px; border: thick solid rgb(153, 153, 153); margin: auto;">
		<fieldset>
		     <label for="radio-1" style="font-size:2em" >결제 기부하기</label>
		          <input type="radio" name="radio" id="radio-1" onclick="move()" >
		          </fieldset>
		...
		<div class="col-md-6 " style="text-align: center;">
		<div class="bbb" style="background-color: beige; color:rgb(206, 187, 13) ; padding: 80px; height: 200px; border: thick solid rgb(153, 153, 153);">
		<fieldset>
		...
		<div class="row">
		     <div class="col-md-6 " style="margin-left: 100px; height: 400px;">
		...
		<div class="col-md-7" style="font-size: medium; line-height: 3em;" >
		     <b>2020 . 09 ~ 2020 . 11</b> <br>
		     <b>2020 . 10 . 05 (매월 둘째 주 월요일)</b><br>
		     열매나눔재단<br>
		     네이버페이 / 카카오페이
		</div>  
		<button style="margin-top: 100px;">모금함으로 돌아가기</button>
		...
		<script>
          ...
          <script>
               ...
               function move(){
            	   location.href ="${contextPath}/donation/dPaymentOnec";
               }
